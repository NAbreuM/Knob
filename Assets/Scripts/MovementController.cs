                ...
                if (DoorKnobs.Count > 0)
                {
                    ...
                    if (hit.Length > 0 && hit[0].transform.tag == "WallDoor")
                    {
                        ...
                        if (DoorKnobs[DoorKnobs.Count - 1].transform.eulerAngles.y % 180 == 0)
                        {
                            ...
                            {
                                DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localScale = new Vector3(hit[0].transform.localScale.x, hit[0].transform.localScale.y, (hit[0].point.z - (hit[0].transform.position.z - (hit[0].transform.localScale.z / 2))) - (DoorKnobs[DoorKnobs.Count - 1].doorGapX / 2));
                                DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localPosition = new Vector3(hit[0].transform.position.x - DoorKnobs[DoorKnobs.Count - 1].transform.position.x, DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localPosition.y, hit[0].transform.position.z - (hit[0].transform.localScale.z / 2) + (DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localScale.z / 2) - (DoorKnobs[DoorKnobs.Count - 1].transform.position.z));
                                DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(1).localScale = new Vector3(hit[0].transform.localScale.x, hit[0].transform.localScale.y, (hit[0].transform.localScale.z - (hit[0].point.z - (hit[0].transform.position.z - (hit[0].transform.localScale.z / 2)))) - (DoorKnobs[DoorKnobs.Count - 1].doorGapX / 2));
                                DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(1).localPosition = new Vector3(hit[0].transform.position.x - DoorKnobs[DoorKnobs.Count - 1].transform.position.x, DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(1).localPosition.y, hit[0].transform.position.z - (hit[0].transform.localScale.z / 2) + (DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localScale.z + DoorKnobs[DoorKnobs.Count - 1].doorGapX + (DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(1).localScale.z / 2) - (DoorKnobs[DoorKnobs.Count - 1].transform.position.z)));



                                DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(2).localScale = new Vector3((hit[0].point.x - (hit[0].transform.position.x - (hit[0].transform.localScale.x / 2))) - (DoorKnobs[DoorKnobs.Count - 1].doorGapY / 2), hit[0].transform.localScale.y, hit[0].transform.localScale.z);
                            ...
                            else
                            {
                                ...
                                DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(2).localScale = new Vector3(hit[0].transform.localScale.x - (hit[0].point.y - (hit[0].transform.position.y - (hit[0].transform.localScale.x/2)) + (DoorKnobs[DoorKnobs.Count - 1].doorGapY / 2)), hit[0].transform.localScale.y, hit[0].transform.localScale.z);
                        ...
                        {
                            DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localScale = new Vector3(hit[0].transform.localScale.x, hit[0].transform.localScale.y, (hit[0].point.x - (hit[0].transform.position.x - (hit[0].transform.localScale.z / 2))) - (DoorKnobs[DoorKnobs.Count - 1].doorGapX / 2));
                            DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localPosition = new Vector3(hit[0].transform.position.y - DoorKnobs[DoorKnobs.Count - 1].transform.position.y, DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localPosition.y, hit[0].transform.position.x - (hit[0].transform.localScale.z / 2) + (DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localScale.z / 2) - (DoorKnobs[DoorKnobs.Count - 1].transform.position.x));
                            DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(1).localScale = new Vector3(hit[0].transform.localScale.x, hit[0].transform.localScale.y, (hit[0].transform.localScale.z - (hit[0].point.x - (hit[0].transform.position.x - (hit[0].transform.localScale.z / 2)))) - (DoorKnobs[DoorKnobs.Count - 1].doorGapX / 2));
                            DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(1).localPosition = new Vector3(hit[0].transform.position.y - DoorKnobs[DoorKnobs.Count - 1].transform.position.y, DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(1).localPosition.y, hit[0].transform.position.x - (hit[0].transform.localScale.z / 2) + (DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(0).localScale.z + DoorKnobs[DoorKnobs.Count - 1].doorGapX + (DoorKnobs[DoorKnobs.Count - 1].transform.GetChild(1).localScale.z / 2) - (DoorKnobs[DoorKnobs.Count - 1].transform.position.x)));
